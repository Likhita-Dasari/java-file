/*Even here we cannot declare it as public because, the main function that is declared in a class
must be
public and it should match with the file name.Since I already wrote it , Iam defining it as
default class and i will
to access it.*/
class Public
{
public
